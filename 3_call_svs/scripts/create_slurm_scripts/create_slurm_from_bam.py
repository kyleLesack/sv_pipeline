...
def create_slurm_script(file_prefix,reference_bam_file,input_path,output_path,array_index):
	with open(TEMPLATE_FILE, 'r') as file :
		output_file = args.output_dir +"/" + file_prefix + "." + str(array_index)
		filedata = file.read()
		filedata = filedata.replace('INPUT_DIR', input_path)
...
def create_template_replacements(root, f,array_index):
	output_path = root.replace("2_align_reads", "3_call_svs")
	...
	create_slurm_script(file_prefix,reference_bam_file,root,output_path,array_index)
