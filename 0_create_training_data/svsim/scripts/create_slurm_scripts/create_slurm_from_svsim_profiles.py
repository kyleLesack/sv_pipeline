...
def make_slurm_file(profile_file,job_name,array_id_number,template_file,output_dir):
...
def get_profile_files(template_file,output_dir):
	...
	for file in os.listdir(args.input_dir):
		if file.endswith(".txt"):
			...
			make_slurm_file(profile_file,job_name,array_id_number,template_file,output_dir)
			array_id_number += 1
...
if args.sv_type=="DEL":
	...
	if os.path.isdir(args.output_dir):
		get_profile_files(template_file,output_dir)
	else:
